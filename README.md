...
<img src='pytorch-CycleGAN-and-pix2pix/imgs/horse2zebra.gif' align="right" width=384>
...
You may find useful information in [training/test tips](pytorch-CycleGAN-and-pix2pix/docs/tips.md) and [frequently asked questions](pytorch-CycleGAN-and-pix2pix/docs/qa.md). To implement custom models and datasets, check out our [templates](#custom-model-and-dataset). To help users better understand and adapt our codebase, we provide an [overview](pytorch-CycleGAN-and-pix2pix/docs/overview.md) of the code structure of this repository.
...
<img src='pytorch-CycleGAN-and-pix2pix/imgs/edges2cats.jpg' width="400px"/>
...
- Install [PyTorch](http://pytorch.org) and 0.4+ and other dependencies (e.g., torchvision, [visdom](https://github.com/facebookresearch/visdom) and [dominate](https://github.com/Knio/dominate)).
  ...
  - For Docker users, we provide the pre-built Docker image and Dockerfile. Please refer to our [Docker](pytorch-CycleGAN-and-pix2pix/docs/docker.md) page.
...
## [Docker](pytorch-CycleGAN-and-pix2pix/docs/docker.md)
We provide the pre-built Docker image and Dockerfile that can run this code repo. See [docker](pytorch-CycleGAN-and-pix2pix/docs/docker.md).

## [Datasets](pytorch-CycleGAN-and-pix2pix/docs/datasets.md)
Download pix2pix/CycleGAN datasets and create your own datasets.

## [Training/Test Tips](pytorch-CycleGAN-and-pix2pix/docs/tips.md)
Best practice for training and testing your models.

## [Frequently Asked Questions](pytorch-CycleGAN-and-pix2pix/docs/qa.md)
Before you post a new question, please first look at the above Q & A and existing GitHub issues.

## Custom Model and Dataset
If you plan to implement custom models and dataset for your new applications, we provide a dataset [template](pytorch-CycleGAN-and-pix2pix/data/template_dataset.py) and a model [template](pytorch-CycleGAN-and-pix2pix/models/template_model.py) as a starting point.

## [Code structure](pytorch-CycleGAN-and-pix2pix/docs/overview.md)
To help users better understand and use our code, we briefly overview the functionality and implementation of each package and each module.

## Pull Request
You are always welcome to contribute to this repository by sending a [pull request](https://help.github.com/articles/about-pull-requests/).
Please run `flake8 --ignore E501 .` and `python ./scripts/test_before_push.py` before you commit the code. Please also update the code structure [overview](pytorch-CycleGAN-and-pix2pix/docs/overview.md) accordingly if you add or remove files.
...
## Other Languages
[Spanish](pytorch-CycleGAN-and-pix2pix/docs/README_es.md)
